(function () {
	var app = angular.module("moto", ["google-maps"]);

	app.config(function($routeProvider){
		$routeProvider
			.when('/', {
				templaceUrl: 'index.html',
				controller: 'GetSpots'
			});
			.when('/list', {
				templaceUrl: 'index.html'
	...
	app.controller('GetSpots', function($scope, $http, $q, $route){
		...
		if(!$scope.spotDetails.hasOwnProperty('id')){
